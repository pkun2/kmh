    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        .requestMatchers("/", "/api/auth/register", "/api/auth/login", "/api/posts/latest",  "/api/channel/get", "/api/channel/post", "/api/posts/test", "/api/image/upload", "api/add/comment").permitAll()
